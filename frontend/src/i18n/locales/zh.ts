export const zh = {
  ...
  'profile.wechat': '微信',
  'profile.wechatLinked': '已绑定',
  'profile.wechatBindTitle': '绑定微信',
  'profile.deleteAccount': '注销账号',
  'profile.deleteAccountDesc': '永久删除你的账号及全部云端数据（桌面布局、书签、壁纸、已绑定的登录方式等），且无法恢复。注销后微信/邮箱等身份会被释放，可重新用于其他账号。',
  'profile.deleteAccountConfirm': '请输入用户名 {username} 以确认',
  'profile.deleteAccountButton': '永久注销',
  'profile.deleteAccountFailed': '注销失败，请重试。',
  ...
  'auth.wechat': '微信登录',
  'auth.wechatScanHint': '微信扫码关注公众号后，在对话中发送验证码完成登录',
  'auth.wechatSearchAccount': '在微信中搜索并关注「{name}」',
  'auth.wechatFollowAccount': '在微信中搜索并关注本公众号',
  ...
  'auth.wechatSuccess': '验证成功',
  'auth.wechatFailed': '微信登录失败，请重试。',
