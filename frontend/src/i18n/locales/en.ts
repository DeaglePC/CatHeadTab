export const en = {
  ...
  'profile.wechatLinked': 'Linked',
  'profile.wechatBindTitle': 'Bind WeChat',
  'profile.deleteAccount': 'Delete account',
  'profile.deleteAccountDesc': 'Permanently delete your account and all cloud data (desktop layout, bookmarks, wallpaper, linked logins). This cannot be undone. Afterwards the freed identities (WeChat/email) can be reused for another account.',
  'profile.deleteAccountConfirm': 'Type your username {username} to confirm',
  'profile.deleteAccountButton': 'Delete permanently',
  ...
  'auth.wechat': 'Continue with WeChat',
  'auth.wechatScanHint': 'Follow the account in WeChat, then send the code below in the chat to sign in',
  'auth.wechatSearchAccount': 'Search and follow “{name}” in WeChat',
  'auth.wechatFollowAccount': 'Search and follow the account in WeChat',
  ...
  'auth.wechatSuccess': 'Verified',
  'auth.wechatFailed': 'WeChat login failed. Please try again.',
